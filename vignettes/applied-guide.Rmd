...
The A1 method automatically projects specifications that violate its proxy
lower bound to the A1 feasibility boundary. The A2-MN method attempts exact
matching without that Negative Binomial lower-bound projection, but it still
requires the package-wide moment domain and can fail for truly infeasible or
numerically ill-conditioned targets.
