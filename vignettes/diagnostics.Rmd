...
scenarios where the size-biased first stick-breaking cluster mass exceeds one
half.
...
```{r fig-w1-plot, echo=FALSE, fig.height=4, fig.cap="Distribution of the first stick-breaking weight w1.", fig.alt="A density plot showing the prior distribution of the first stick-breaking weight and dominance thresholds."}
...
```{r refinement-step3, echo=FALSE, fig.height=4, fig.cap="The K-only prior shows high dominance risk.", fig.alt="A diagnostic plot showing substantial prior mass above the dominance threshold for the first stick-breaking weight."}
