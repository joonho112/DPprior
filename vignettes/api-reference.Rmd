...
| `...` | Dots | Reserved for future method-specific extensions. |
...
| `J` | Sample size |
| `target` | List with target specification, including `mu_K`, `var_K`, `var_K_used`, and optionally `pmf` |
...
fit5 <- DPprior_fit(J = 30, target_pmf = target_pmf,
